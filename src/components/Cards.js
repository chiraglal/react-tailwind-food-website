...
const Cards = () => {
  return (
    <div className="max-w-[1640px] mx-auto py-12 px-4 grid md:grid-cols-3 gap-6">
      {/* Card */}
      <div className="rounded-xl relative">
        ...
        <div className="absolute w-full h-full bg-black/50 rounded-xl text-white">
          ...
          <p className="px-2">Lorem ipsum dolor sit.</p>
          <button className="border-white bg-white text-black mx-2 absolute bottom-4">
            Order Now
          </button>
        </div>
        <img
          src="https://images.unsplash.com/photo-1499028344343-cd173ffc68a9?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80"
          alt="/"
